(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Botswana (BWA)
  market-entry compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no tender risk
                                 yet) may auto-commit.
  ...
  real IPMS tender-response package and submitting a real filing are
