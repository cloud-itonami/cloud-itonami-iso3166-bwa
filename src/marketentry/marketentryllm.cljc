(ns marketentry.marketentryllm
  ...
  the Republic of Botswana (BWA) public-sector market-entry compliance
  actor.
  ...
  cited), never a committed record or a real IPMS tender response.
...
(defn- propose-submit
  ...
  :actuation/submit-filing` -- real-world IPMS tender response
  submission."
  [db {:keys [subject]}]
  (let [e (store/engagement db subject)]
