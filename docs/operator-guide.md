...
- named referral relationship with Botswanan-licensed counsel or a
...
a working referral relationship with Botswanan-licensed counsel or a
registered agent for whatever licensed representation the law of
Botswana requires for actual public-procurement filings.
